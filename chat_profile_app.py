...
# #         cl.ChatProfile(
# #             name="NFR",
# #             markdown_description="The **NFR** profile specializes in *Non-Functional Requirements* discussions.",
# #             icon="https://picsum.photos/200"
# #         ),
# #         cl.ChatProfile(
# #             name="Knowledge Assistant",
# #             markdown_description="A **Knowledge Assistant** profile (powered by GPT-4) for factual Q&A.",
...
# #     # Retrieve and announce the selected chat profile
# #     chat_profile = cl.user_session.get("chat_profile")
# #     await cl.Message(content=f"✅ Starting chat with profile: {chat_profile}").send()
...
# # -----------------------------
# # Define Chat Profiles (center UI style)
# # -----------------------------
# @cl.set_chat_profiles
# async def chat_profiles(current_user: cl.User):
#     """
#     Define the available profiles that will appear
#     in the center of the UI before chat starts.
#     """
#     return [
#         cl.ChatProfile(
#             name="NFR",
#             markdown_description="The **NFR Assistant** helps you discuss and analyze *Non-Functional Requirements* (Performance, Security, Scalability, etc.).",
#             icon="https://picsum.photos/200"
#         ),
#         cl.ChatProfile(
#             name="Knowledge Assistant",
#             markdown_description="The **Knowledge Assistant** answers questions and provides insights based on facts, documents, and structured knowledge.",
#             icon="https://picsum.photos/250"
#         ),
#     ]
...
#     chat_profile = cl.user_session.get("chat_profile")
#     await cl.Message(
#         content=f"✅ Starting chat with **{chat_profile}** profile."
#     ).send()
...
#     response = f"Echo ({cl.user_session.get('chat_profile')}): {msg.content}"
...
async def on_chat_start():
    ...
    chat_profile = cl.user_session.get("chat_profile")
    await cl.Message(content=f"✅ Starting with profile: **{chat_profile}**").send()
