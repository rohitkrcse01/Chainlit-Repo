...
class MongoDataLayer(BaseDataLayer):
    ...
    async def create_step(self, step_dict: dict):
        ...
        if tid:
            ...
            # ✅ Ensure user_id is written to thread
            if "user_id" in step_dict:
    ...
    async def delete_thread(self, thread_id: str):
        ...
        await self.col_feedback.delete_many({"thread_id": thread_id})
        return True
    ...
    async def list_threads(self, pagination, filters):
        ...
        for it in raw_items:
            ...
            # CamelCase timestamps for Chainlit UI
    ...
    async def get_thread(self, thread_id: str):
        ...
        steps_cursor = self.col_steps.find({"thread_id": thread_id}).sort("created_at", 1)
    ...
    async def update_thread(
        ...
        if user_id is not None:
            patch["user_id"] = user_id   # ✅ always persist user_id
